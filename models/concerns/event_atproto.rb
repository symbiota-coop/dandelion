module EventAtproto
  ...
  def publish_to_atproto
    ...
    ErrorReporting.capture_exception(e, context: { event_id: id.to_s, action: 'publish' })
  end
  ...
  def update_atproto
    ...
    ErrorReporting.capture_exception(e, context: { event_id: id.to_s, action: 'update' })
  end
  ...
  def delete_atproto
    ...
    ErrorReporting.capture_exception(e, context: { event_id: id.to_s, action: 'delete' })
  end
  ...
  def sync_to_atproto(dry_run: false)
    ...
    ErrorReporting.capture_exception(e, context: { event_id: id.to_s, action: 'sync' })
