module EventFields
  ...
  included do
    ...
    attr_accessor :prevent_notifications, :duplicate, :update_activity_events, :prevent_order_refunds
    ...
    def new_hints
      {
        ...
        gocardless_instalment_count: 'Split the ticket price into this many monthly Direct Debit payments (2–24). Shown at checkout for GBP and EUR events. Tickets are emailed when the mandate and payment schedule are set up. Leave blank to hide this option.',
