    ...
    def human_attribute_name(attr, options = {})
      {
        ...
        restrict_cohosting: 'Restrict cohosting to admins and event creators',
    ...
    def new_hints
      {
        ...
        restrict_cohosting: 'When checked, only this organisation\'s admins and event creators can add it as a co-host of events',
