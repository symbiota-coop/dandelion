  ...
  def self.new_hints
    {
      ...
      questions: 'Questions to ask participants upon booking. One question per line. Add headers by starting a line with #. Wrap in [square brackets] to turn into a checkbox, add a [star]* to make a checkbox required. View answers on the Orders page.',
