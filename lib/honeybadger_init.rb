Honeybadger.configure do |config|
  config.before_notify do |notice|
    ...
    should_ignore = [
      ...
      error_type == 'Sinatra::BadRequest' && error_message && error_message.include?('Invalid multipart/form-data: Rack::Multipart::EmptyContentError'),
      ...
      error_type == 'Mongoid::Errors::Validations' && error_message && error_message.include?('Ticket type is not available as sales have ended'),
