module Dandelion
  class App < Padrino::Application
    ...
    before do
      ...
      redirect "#{ENV['BASE_URI']}#{request.path}#{"?#{request.query_string}" if request.query_string}" if ENV['REDIRECT_BASE'] && ENV['BASE_URI'] && (ENV['BASE_URI'] != "#{request.scheme}://#{request.env['HTTP_HOST']}")
      begin
