    ...
    if params[:i] == 'featured'
      ...
      begin
        ...
        @events =
          ...
          @organisation.events_for_search.past.and(:extra_info_for_recording_email.ne => nil).and(:image_uid.ne => nil).and(:id.in => EventTagship.and(:event_tag_id.in => EventTag.and(:name.in => tags).pluck(:id)).pluck(:event_id)).limit(20)
