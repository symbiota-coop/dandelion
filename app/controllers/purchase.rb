  ...
  post '/events/:id/purchase', provides: :json do
    ...
    begin
      @order = Order.create!(
        ...
        answers: (detailsForm[:answers].map.with_index { |x, i| [detailsForm[:questions][i], ((x.is_a?(Hash) ? x.values : x) unless x == 'false')] } if detailsForm[:answers] && detailsForm[:questions]),
