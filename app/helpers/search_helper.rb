...
Dandelion::App.helpers do
  ...
  def perform_ajax_search(q, model_class = nil)
    ...
    search_type_config.each do |config_model_class, config|
      ...
      items = config_model_class.search(q, scope, limit: 5, build_records: true, phrase_boost: 1.5, include_text_search: true)
  ...
  def perform_full_search(q, model_class)
    ...
    # Perform search
    results = model_class.search(q, scope, build_records: true, phrase_boost: 1.5, include_text_search: true)
